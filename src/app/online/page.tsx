  ...
  return (
    <div className="container-x space-y-6 py-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <h1 className="font-display text-3xl font-black text-white neon-text">Online Oyunlar</h1>
        <span className="rounded-full border border-line px-3 py-1 text-sm text-slate-400">{games.length} oyun</span>
      </div>
      <p className="max-w-3xl text-slate-400">
        Çok oyunculu <strong className="text-white">.io arenaları</strong>, <strong className="text-white">online FPS</strong> nişancı
