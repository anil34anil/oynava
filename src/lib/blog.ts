...
const BASE_POSTS: Post[] = [
  {
    ...
    body: [
      "Çok oyunculu bir arenada rakibin bir adım önde görünmesi ya da nişanının bir tık geç açılması, çoğu zaman beceri değil gecikme (ping) sorunudur. Tarayıcı tabanlı online oyunlarda bile bu detayları düzeltmek maçın kaderini değiştirebilir.",
      "## Ping neden yükselir?",
      "- Kalabalık Wi-Fi ağı: Aynı ağda çok cihaz varken sinyal paylaşımı gecikmeyi artırır.",
      "- Arka planda güncelleme/indirme: Bant genişliğini paylaşan işlemler oyunun önüne geçer.",
      "- Tarayıcı sekmesi kalabalığı: Açık kalan gereksiz sekmeler işlemciyi ve ağı meşgul eder.",
      "## Hızlı çözümler",
      "- Mümkünse kablolu (Ethernet) bağlantı kullan; Wi-Fi'den çok daha stabildir.",
      "- Oyuna başlamadan önce gereksiz sekme ve indirmeleri kapat.",
      "- Tarayıcını güncel tut; eski sürümler ağ isteklerini daha yavaş işleyebilir.",
      "- Donanım hızlandırmayı (hardware acceleration) tarayıcı ayarlarından açık tut.",
      "## Oyun içi davranışla telafi",
      "Gecikme tamamen sıfırlanmaz; bu yüzden iyi oyuncular biraz payı içine katar. Köşeye sıkışmadan, önden tahmin ederek hareket etmek ve ani yön değişikliklerinden kaçınmak, yüksek pingde bile rekabetçi kalmanı sağlar.",
      "## Nereden oynanır?",
      "Oynava'nın [Online Oyunlar](/online) ve [Ücretsiz Online Oyunlar](/ucretsiz-online-oyunlar) sayfalarında çok oyunculu .io arenaları ve online FPS oyunlarının en iyileri bir arada. Nişancılığını geliştirmek istersen [FPS / Nişancı Oyunları](/en-iyi-nisanci-oyunlari) koleksiyonuna da göz atabilirsin — hepsi ücretsiz ve indirmeden tarayıcıda oynanır.",
    ],
  },
  {
    ...
    body: [
      "Bilgi yarışması oyunları, klasik bir yarışma programını tarayıcına taşır: sorular gelir, süre işler, doğru cevap puan getirir. Basit görünen bu döngü, rekabet hissiyle birleşince saatlerce oynatabilir.",
      "## Neden bu kadar sevilir?",
      "- Hızlı tempo: Her soru birkaç saniyede cevaplanır, oyun asla yavaşlamaz.",
      "- Anlık geri bildirim: Doğru ya da yanlış olduğunu hemen öğrenirsin.",
      "- Rekabet: Skor tablosu veya arkadaşına karşı yarışma modu, tekrar oynatma isteği uyandırır.",
      "## Daha çok puan toplamanın yolları",
      "- İlk birkaç soruda acele etmeden ritmi yakala; panik yanlış cevap yaptırır.",
      "- Süreye karşı oynanan modlarda emin olduğun soruları önce işaretle.",
      "- Kategori seçimi varsa güçlü olduğun alandan başla, güven kazandıktan sonra zorlarına geç.",
      "## Kelime ve sayı oyunlarıyla ilişkisi",
      "Bilgi yarışmaları genelde kelime oyunları ve mantık bulmacalarıyla aynı zihinsel kası çalıştırır: hızlı hatırlama, örüntü tanıma ve doğru tahmin. Bu yüzden bir türü sevenler genelde diğerinden de keyif alır.",
      "## Nereden oynanır?",
      "Oynava'nın [Bilgi Yarışması Oyunları](/bilgi-yarismasi-oyunlari) sayfasında quiz ve trivia oyunlarının en iyileri ücretsiz ve indirmeden oynanır. Kelime tutkunları [Kelime Oyunları](/kelime-oyunlari) sayfasına da bakabilir.",
    ],
  },
  {
    ...
    body: [
      "Blok bulmaca oyunları, basit bir kuralla dev bir tür yarattı: şekilleri doğru yere yerleştir, satırı tamamla, patlat. Tempolu ama düşünmeyi de ödüllendiren bu denge, türü onlarca yıldır zirvede tutuyor.",
      "## Temel mekanik",
      "- Düşen bloklar: Farklı şekildeki parçalar yukarıdan gelir, sen döndürüp yerleştirirsin.",
      "- Satır/alan temizleme: Bir sırayı veya alanı tam doldurmak puan kazandırır ve yer açar.",
      "- Hızlanan tempo: Seviye ilerledikçe bloklar daha hızlı düşer, karar süresi kısalır.",
      "## Yüksek skor için teknikler",
      "- Boşluk bırakmamaya çalış; her boşluk ileride doldurulması zor bir kuyu yaratır.",
      "- Uzun parçaları (dikey/yatay çubuklar) acil durumlar için sona sakla.",
      "- Ekranın alt yarısını düzenli tutmak, panik anlarında hızlı karar vermeni kolaylaştırır.",
      "## Neden rahatlatıcı ama bağımlılık yapıyor?",
      "Her tamamlanan satır küçük bir ödül hissi verir; bu da 'bir tur daha' dedirten döngüyü besler. Aynı zamanda net kurallar ve anlık geri bildirim, bulmaca severlerin en çok aradığı özelliklerdir.",
      "## Nereden oynanır?",
      "Oynava'nın [Tetris Tarzı Blok Oyunları](/tetris-oyunlari) sayfasında en iyi blok bulmacaları ücretsiz ve indirmeden oynanır. Daha fazla zihin oyunu için [En İyi Bulmaca Oyunları](/en-iyi-bulmaca-oyunlari) koleksiyonuna da bakabilirsin.",
    ],
  },
  {
